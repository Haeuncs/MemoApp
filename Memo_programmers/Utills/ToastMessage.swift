...
class ToastMessage: UIView {
  ...
  public static func show(message: String) {
    ...
    let alertHeight = CGFloat(54 + 50 + Constant.UI.safeInsetBottomiOS10)

    let alert = ToastMessage(frame: CGRect(x: 0,
                                           y: window.frame.maxY + alertHeight,
  ...
  private func setup() {
    ...
    contentView.snp.makeConstraints { (make) in
      ...
      make.bottom.equalTo(self.snp.bottom).offset(-50-Constant.UI.safeInsetBottomiOS10)
    }
